...
const Navbar = () => {
  ...
  return (
    <Header
      className="flex items-center justify-between bg-white shadow-md rounded-full px-6 py-3"
...
//   return (
//     <Header className="flex items-center justify-between bg-white border rounded-full p-4 mt-2 shadow-md">
//       <div className="flex items-center">
//         <FontAwesomeIcon icon={faHome} className="text-black text-2xl mr-2" />
...
//         <div className="flex items-center">
//           <Avatar src={profileImage} className="bg-gray-950 mr-2" size={40}>
//             {!profileImage &&
//               (decodedToken ? getInitials(decodedToken.name) : <UserOutlined />)}
//           </Avatar>
//           <div
//             className="text-lg font-semibold mr-4 cursor-pointer"
//             onClick={showProfile}
//           >
//             <div className="text-black">{decodedToken?.name}</div>
//             <div className="text-sm">{role}</div>
//           </div>
//           <Dropdown overlay={menu}>
//             <SettingOutlined className="text-black text-2xl ml-6" />
//           </Dropdown>
//         </div>
//       </div>
